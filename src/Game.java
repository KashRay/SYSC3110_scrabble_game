...
public class Game {
    ...
    public boolean ValidateMove(boolean firstTurn) {
        ...
        this.updateBoard(true); //Tell views to make tiles permanent
        this.updateViewsTopText("Valid move! " + this.getCurrentPlayer().getName() + " scored " + totalScore + " points.");

        placedTiles.clear();
        if (firstTurn) this.disableViewsFirstMove();
