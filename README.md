...
- **Model:** (`Game`, `Board`, `Player`, `AIPlayer`, `Tile`, `TileBag`, `Dictionary`) supporting premium squares, blank tiles, scoring rules, AI turns, and AIMove validation.
...
- **AI Player:** Generates and evaluates all legal moves, choosing the **highest-scoring valid AIMove** based on full board simulation.
- **Dictionary:** File-based loading and validation of all words used by the player and AI.
- **Testing:** JUnit tests covering AIMove validation, scoring, dictionary loading, blank tile rules, premium squares, and AI legality.
...
5. Track the highest-scoring legal AIMove.